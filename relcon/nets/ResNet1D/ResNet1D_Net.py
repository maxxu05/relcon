...
class Net(nn.Module):
    ...
    def __init__(self, finalpool, init_conv, init_maxpool, blocks):
        super().__init__()

        # first block
        self.first_block_conv = nn.Conv1d(
        ...
        self.first_block_maxpool = nn.MaxPool1d(
            kernel_size=init_maxpool["kernel_size"], stride=init_maxpool["stride"]
        )
