...
class Base_ModelClass():
    ...
    @abstractmethod
    def setup_dataloader(self, data: torch.Tensor, labels: torch.Tensor, train: bool) -> torch.utils.data.DataLoader:
        ...
    ...
    def fit(self):
        ...
        start_epoch = 0
        if (self.resume_on) and (os.path.exists(os.path.join(self.run_dir,
            ...
            if (os.path.exists(os.path.join(self.run_dir,"checkpoint_best.pkl"))):
                best_state_dict = torch.load(f'{self.run_dir}/checkpoint_best.pkl',
