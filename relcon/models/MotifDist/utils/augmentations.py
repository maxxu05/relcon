...
"""
Code borrowed from here: https://github.com/ubicompsoartutorial/soar_tutorial/blob/main/simclr/transformations.py
...
def noise_transform(X, sigma=0.1):
    """
...
def scaling_transform(X, sigma=0.25):
    """
...
def axis_angle_to_rotation_matrix_3d(axes, angles):
    """
    Get the rotational matrix corresponding to a rotation of (angle) radian
    around the axes
...
def channel_shuffle_transform(X):
    """
...
def time_segment_permutation_transform(X, num_segments=5):
    """
